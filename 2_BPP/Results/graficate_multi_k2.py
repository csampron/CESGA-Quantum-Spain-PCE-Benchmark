...
# RUTAS BD
# ---------------------------------------------------
DB_NAME_NONREG = "/mnt/netapp1/Store_CESGA/home/cesga/falonso/z_BPP/A_DIFFERENTIAL_COMPARISON/Comparison_k/Simul_k2/Resultados/BPP_results.db"

DB_NAME_REG = "/mnt/netapp1/Store_CESGA/home/cesga/falonso/z_BPP/A_DIFFERENTIAL_COMPARISON/Comparison_reg/Simul_k2/Resultados/BPP_results.db"
...
plt.savefig(os.path.join(FIG_DIR, f"BPP_pct_reg_vs_nonreg_k{k}.png"),
...
plt.savefig(os.path.join(FIG_DIR, f"BPP_npq_reg_vs_nonreg_k{k}.png"),
            dpi=200, bbox_inches='tight')
plt.close()
...
plt.savefig(os.path.join(FIG_DIR, f"BPP_bins_reg_vs_nonreg_k{k}.png"),
            dpi=200, bbox_inches='tight')
plt.close()

...
plt.savefig(os.path.join(FIG_DIR, "BPP_k3_YJ_pct_factibles.png"), dpi=200)
plt.close()
...
plt.savefig(os.path.join(FIG_DIR, "BPP_k3_YJ_best_npq_used_post_vs_benchmark.png"), dpi=200)
plt.close()
...
plt.savefig(os.path.join(FIG_DIR, "BPP_k3_YJ_num_bins_used_post_vs_benchmark.png"), dpi=200)
plt.close()

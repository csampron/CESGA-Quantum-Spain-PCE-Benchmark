...
plt.title("Percentage of feasible solutions por JSON - k=3 ")
plt.xlabel("n")
...
plt.savefig(os.path.join(FIG_DIR, "BPP_reg_k3_YJ_pct_factibles.png"), dpi=200)
plt.close()
...
plt.title("NPQ best solution vs Benchmark - k=3")
plt.xlabel("n")
plt.ylabel("NPQ")
plt.xticks(x, ns)
plt.ylim(0, 1.3)
...
plt.savefig(os.path.join(FIG_DIR, "BPP_reg_k3_YJ_best_npq_used_post_vs_benchmark.png"), dpi=200)
plt.close()
...
plt.title("Number of bins vs Benchmark - k=3")
plt.xlabel("n")
...
plt.savefig(os.path.join(FIG_DIR, "BPP_reg_k3_YJ_num_bins_used_post_vs_benchmark.png"), dpi=200)
plt.close()

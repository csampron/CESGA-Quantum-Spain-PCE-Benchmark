...
# === CONFIGURACIÓN ===
BASE_DIR = "/mnt/netapp1/Store_CESGA/home/cesga/falonso/z_MaxCut/A_DIFFERENTIAL_COMPARISON/Comparison_k_sign/Simul_k4"
...
folders_to_search = [
    ("Simulation", os.path.join(BASE_DIR, "Resultados", "MaxCut"))
]

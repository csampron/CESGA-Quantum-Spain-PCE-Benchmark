...
OUTPUT_DIR = "/mnt/netapp1/Store_CESGA/home/cesga/falonso/z_MaxCut/A_DIFFERENTIAL_COMPARISON/Comparison_k/Simul_k3"
...
for optimizador in ["DIFFERENTIALEVOLUTION"]:
    ...
    plt.title(f"Simulation | Optimizer: {optimizador} | k=3")
    ...
    output_path = os.path.join(
        IMAGES_DIR, 
        f"MaxCut_grafico_r_{optimizador}_k3.png"
    )

...
def ejecutar_maxcut(
    ...
    if cunqa_str_arg == "Simulation":
        ...
        subcarpeta_csv = f"Resultados/MaxCut/{cunqa_str_arg}/{nqpus}qpus/{num_ver}_vertices/{optimizer}"
    ...
    if cunqa_str_arg == "Simulation":
        ...
        subcarpeta = f"Resultados/MaxCut/{cunqa_str_arg}/{nqpus}qpus/{num_ver}_vertices/{optimizer}/"

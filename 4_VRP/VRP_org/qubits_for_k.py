...
output_dir = "/mnt/netapp1/Store_CESGA/home/cesga/falonso/z_VRP/VRP_org"
os.makedirs(output_dir, exist_ok=True)

plot_results(
    ORDERS_FULL,
    results_full,
    os.path.join(output_dir, "1_Evolucion_cubits_VRP_org.png")
)

plot_results(
    ORDERS_PARTIAL,
    results_partial,
    os.path.join(output_dir, "2_Evolucion_cubits_VRP_org.png")
)

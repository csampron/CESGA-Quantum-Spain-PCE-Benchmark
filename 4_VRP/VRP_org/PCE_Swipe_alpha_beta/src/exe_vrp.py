...
def ejecutar_vrp(
    ...
    num_qubits,
    get_vrp_routes_from_expmap_obj,
    vrp_postprocess,
    refine_vrp_routes
    )
    ...
    # Obtener rutas iniciales como objetos tipo TSP
    initial_routes, initial_cost, x_values = get_vrp_routes_from_expmap_obj(
        last_exp_map, G, alpha, A=num_ver, max_clients_per_vehicle=Capacity
    )

    print("Initial tour:", initial_routes)
    print("Initial distance:", initial_cost)
    ...
    print("Refined tour:", refined_routes)
    print("Refined distance:", refined_cost)

#!/usr/bin/env python3
# Evolucion_cubits_TSP_colores_fijos.py
...
ORDER_COLORS = {
    1: DEFAULT_COLORS[0],  # azul
    2: DEFAULT_COLORS[1],  # naranja
    3: DEFAULT_COLORS[2],  # verde
    4: DEFAULT_COLORS[3],  # rojo
    5: DEFAULT_COLORS[4],  # morado
}
...
def plot_results(order_list, results, filename):
    ...
    plt.xlabel("Number of nodes in each subgraph")
...
plot_results(
    ORDERS_FULL,
    results_full,
    os.path.join(output_dir, "1_Evolucion_cubits_VRP.png")
)

plot_results(
    ORDERS_PARTIAL,
    results_partial,
    os.path.join(output_dir, "2_Evolucion_cubits_VRP.png")
)

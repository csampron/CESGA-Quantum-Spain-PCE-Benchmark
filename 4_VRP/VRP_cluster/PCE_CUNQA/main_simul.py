...
for combo in combinaciones:
    ...
    cluster_csv_paths, cluster_csv_iter_paths = ejecutar_experimentos(exp_list=combo, optimizer_params=optimizer_params, alpha=alpha, beta=beta, maxiter=maxiter, n_shots=n_shots, nqpus = None, cunqa_str = "Simulation", family_name = None)
    

    # Graficar resultados iterativos de todos los clusters

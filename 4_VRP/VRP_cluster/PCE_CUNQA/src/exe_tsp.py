...
def ejecutar_tsp(
    ...
    if cunqa_str_arg == "Simulation":
        subcarpeta = f"Resultados/VRP/{cunqa_str_arg}/k{k}/{tamaño}_vertices/inst_{instancia}/{optimizer}/cluster_{idx}"
    else:
        subcarpeta = f"Resultados/VRP/{cunqa_str_arg}/k{k}/{nqpus}qpus/{tamaño}_vertices/inst_{instancia}/{optimizer}/cluster_{idx}"

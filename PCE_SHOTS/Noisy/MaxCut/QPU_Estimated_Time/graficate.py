...
parser = argparse.ArgumentParser(description="Graficar resultados de experimentos")
...
# Si solo quiero graficar algunos:
# python plot_results.py --shots_to_plot 1000 10000
...
for opt, d in data_por_algoritmo.items():
    ...
    graficar_mejoras(
        d["instances"],
        d["mejora_initial"],
        f"{opt} – Mejora porcentual del mejor initial_distance vs Benchmark - k=3",
    ...
    graficar_mejoras(
        d["instances"],
        d["mejora_refined"],
        f"{opt} – Mejora porcentual del refined_distance vs Benchmark - k=3",
    ...
    graficar_media_std(
        ...
        d["mean_initial"],
        d["std_initial"],
        f"{opt} – Media y desviación típica de initial_distance - k=3",

...
output_dir = "Your_route/z_TSP/A_DIFFERENTIAL_COMPARISON"
os.makedirs(output_dir, exist_ok=True)

plot_results(
    ORDERS_FULL,
    results_full,
    os.path.join(output_dir, "1_Evolucion_cubits_TSP.png")
)

plot_results(
    ORDERS_PARTIAL,
    results_partial,
    os.path.join(output_dir, "2_Evolucion_cubits_TSP.png")
)
